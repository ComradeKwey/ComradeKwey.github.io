 ...
 */
{
	...
	new MorphingBG(document.querySelector('.ja-decor-1 .ja-decor-item'));
	new MorphingBG(document.querySelector('.ja-decor-2 .ja-decor-item'));
	new MorphingBG(document.querySelector('.ja-decor-3 .ja-decor-item'));
	new MorphingBG(document.querySelector('.ja-decor-4 .ja-decor-item'));
	new MorphingBG(document.querySelector('.ja-decor-5 .ja-decor-item'));
	new MorphingBG(document.querySelector('.ja-decor-6 .ja-decor-item'));
};